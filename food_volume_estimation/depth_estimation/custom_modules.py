...
class ProjectionLayer(Layer):
    ...
    def build(self, input_shape):
        self.intrinsics_mat_tensor = tf.constant(self.intrinsics_mat, dtype=tf.float32)
        self.intrinsics_mat_inv_tensor = tf.constant(self.intrinsics_mat_inv, dtype=tf.float32)
